...
fetch(fetchlink)
    ...
    .then(products => {
        ...
        products.forEach((product, index) => {
            ...
            productCard.classList.add('col', 'col-md-6', 'mb-3', 'position-relative', 'p-1'); 

            const cardContent = `
                <div class="card product shadow position-relative">
                    ...
                    <span class="badge bg-dark btn-price position-absolute top-0 end-0 p-2">${product.price}</span>
                </div>
            `;
